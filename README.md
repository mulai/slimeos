...
| Intel NUC6CAYH / Celeron J3455 / 4 GB (Win 10) | 010 | UEFI | ✅ Full install → kiosk → WireGuard tunnel → RDP connect confirmed on real hardware — dedicated profile switches to /gfx:AVC420 to fix choppy video playback (single-threaded AVC444 decode was the bottleneck on this CPU, github.com/mulai/slimeos#14) |
